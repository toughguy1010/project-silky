    ...
    <div class="wrapper">
        ...
        <div class="header-section">
            <nav class="navbar navbar-expand-lg ">
                ...
                <img src="<?php echo get_template_directory_uri() . '/assets/img/header-logo-img.jpg'; ?>" class="logo-respon" />
                            ...
                            <div class="cart-content">
                                <div class="cart-product-list">
                                    <div class="cart-product-item">
                                        ...
                                        <img src="<?php echo get_template_directory_uri() . '/assets/img/cart-product-1.jpg'; ?>" />
                                    ...
                                    <div class="cart-product-item">
                                        ...
                                        <div class="cart-product-img">
                                        <img src="<?php echo get_template_directory_uri() . '/assets/img/cart-product-2.jpg'; ?>" />
                                    ...
                                    <div class="cart-product-item">
                                        ...
                                        <div class="cart-product-img">
                                        <img src="<?php echo get_template_directory_uri() . '/assets/img/cart-product-3.jpg'; ?>" />
